...
sealed class Location {
    ...
    class RecordField(val owner: String, val name: String, val descriptor: TypeDescriptor) : Location() {
    ...
    class Method(val owner: String, val name: String, val descriptor: MethodDescriptor) : Location() {
    ...
    class MethodLocal(val owner: String, val mName: String, val descriptor: MethodDescriptor, val num: Int, val name: String) : Location() {
    ...
    class Field(val owner: String, val name: String, val descriptor: TypeDescriptor) : Location() {
